      ...
      <SimpleGrid className={styles.header} cols={2}>
        ...
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator className="text-white" />
            <BreadcrumbItem>
              <BreadcrumbPage className="text-white">Check In</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
        ...
        <SimpleGrid cols={1} style={{ width: "80%" }} spacing="4rem">
            ...
            <Popover>
                <PopoverTrigger asChild>
                    ...
                    >
                    <CalendarIcon />
                    {date ? format(date, "PPP") : <span>In Date</span>}
                    </Button>
                </PopoverTrigger>
            ...
            <TimeInput label="In Time" ref={ref} style={{color: "black"}} radius={10}/>
